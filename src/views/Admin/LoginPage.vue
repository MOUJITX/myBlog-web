...
<template>
  <div class="login-container">
    <el-form class="login-form" autocomplete="on" ref="formRef" :model="loginForm" :rules="rules" status-icon>
      <div class="title">登录</div>
      <el-form-item prop="username">
        <el-input placeholder="账号" v-model="loginForm.username" autocomplete="on" >
          <template #prepend>
      ...
      <el-form-item prop="password">
        <el-input placeholder="密码" v-model="loginForm.password" autocomplete="on" type="password" show-password >
          <template #prepend>
