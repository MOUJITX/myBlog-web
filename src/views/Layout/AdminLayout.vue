...
<template>
  <el-container class="admin-layout-container">
    <el-aside :width="asideWidth[isCollapse ? 1 : 0]" class="admin-layout-aside">
      ...
      <el-scrollbar>
        <el-menu :default-active="$route.path" router :collapse="isCollapse">
          ...
          <el-menu-item index="/admin/tag"><el-icon>
            <Setting /></el-icon>
            <template #title>标签</template>
          </el-menu-item>
          <el-menu-item index="/admin/resume"><el-icon>
            <Setting /></el-icon>
            <template #title>简历</template>
          </el-menu-item>
          <el-menu-item index="/admin/photo"><el-icon>
            <Setting /></el-icon>
    ...
    <el-container>
      <el-header class="admin-layout-toolbar">
          <div class="admin-layout-toolbar-dropdown">
            <el-icon v-if="!isCollapse" @click="isCollapse = !isCollapse"><Fold /></el-icon>
          ...
          <el-dropdown>
            ...
            <template #dropdown>
              <el-dropdown-menu>
                ...
                <el-dropdown-item style="color: red" @click="logout">退出登录</el-dropdown-item>
              </el-dropdown-menu>
            </template>
          </el-dropdown>
      </el-header>
