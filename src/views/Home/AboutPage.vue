...
const pageSetting:IWebsiteNavigation[] = JSON.parse(localStorage.getItem('web_navigate') || '[]')
const pageSettingItem:IWebsiteNavigation = pageSetting.find(item => item.nav_url === '/about') || {...defaultWebsiteNavigation}
...
<template>
  ...
  <div class="about">
    ...
    <MJTXCard padding>
      <MJTXTimeLine time="2024" time-size="large" event="event text" description="the description of event"/>
      <MJTXTimeLine time="07/01" time-size="medium"><div>123</div></MJTXTimeLine>
