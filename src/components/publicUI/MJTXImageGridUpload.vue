...
<template>
  <el-tabs tab-position="left" v-model="tabsName" @tab-click="handleClick" v-if="!showBtn">
    <el-tab-pane label="上传图片" name="upload">
      <el-upload
        ...
        <div class="el-upload__text">
          将图片拖入框中或<em>点击此处上传</em>
        </div>
      </el-upload>
    </el-tab-pane>
    <el-tab-pane label="选择图片" name="select">
      <MJTXImageGrid v-model="imagesList" ref="MJTXImageGridRef" :limit="props.limit"/>
    </el-tab-pane>
  </el-tabs>
  <MJTXFormButton form="dialog"
                  v-if="showBtn"
                  button-title="选择图片"
                  form-title="选择图片"
                  type="primary"
    ...
    <template #footer>
      ...
      <el-button type="primary" @click="uploadDialogShow = false">确认</el-button>
