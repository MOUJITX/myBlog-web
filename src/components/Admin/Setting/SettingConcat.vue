  ...
  <el-table :data="tableData">
    <el-table-column prop="cc_icon" label="图标">
      <template #default="scope">
        <MJTXImageUpload v-model="scope.row.cc_icon" is-picker @change="dataEdit"/>
      </template>
    </el-table-column>
    ...
    <el-table-column label="操作">
      <template #default="scope">
        ...
        <el-button type="danger" circle @click="dataDel(scope.$index)"><el-icon><Minus /></el-icon></el-button>
      </template>
    </el-table-column>
  </el-table>
</template>
