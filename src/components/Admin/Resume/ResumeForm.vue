  ...
  <el-form
    ...
    <el-form-item label="板块" prop="section">
      <el-select v-model="resumeForm.section">
        <el-option
          v-for="item in resumeSections"
          :key="item.uuid"
          :value="item.uuid"
          :label="item.section"
          :disabled="!item.enabled">
          <el-tag type="danger" v-if="!item.enabled">停用</el-tag
          >{{ item.section }}
        </el-option>
      </el-select>
    </el-form-item>
    ...
    <el-form-item label="方向" prop="direction">
      <el-radio-group v-model="resumeForm.direction">
        <el-radio-button label="row" value="row" key="row"
          >横向</el-radio-button
        >
        <el-radio-button label="column" value="column" key="column"
          >纵向</el-radio-button
        >
      </el-radio-group>
    </el-form-item>
    <el-form-item label="宽度" prop="min_width">
      <el-input-number
        v-model="resumeForm.min_width"
        :min="0"></el-input-number>
      -
      <el-input-number
        v-model="resumeForm.max_width"
        :min="0"></el-input-number>
    </el-form-item>
      ...
      <el-form label-width="auto">
        <el-form-item label="类型">
          <el-radio-group v-model="isText" @change="resumeForm.icon.icon = ''">
            <el-radio-button label="text" :value="true" key="text"
              >文字图标</el-radio-button
            >
            <el-radio-button label="img" :value="false" key="img"
              >图片图标</el-radio-button
            >
          </el-radio-group>
        </el-form-item>
        <el-form-item label="图标">
          <MJTXImageUpload
            v-model="resumeForm.icon.icon"
            v-if="!isText"
            is-picker />
        ...
        <el-form-item label="文字" v-if="isText">
          <el-color-picker
            v-model="resumeForm.icon.textColor"></el-color-picker>
        </el-form-item>
        <el-form-item label="背景">
          <el-color-picker
            v-model="resumeForm.icon.backgroundColor"></el-color-picker>
        </el-form-item>
      </el-form>
    </el-form-item>
    <el-form-item label=" ">
