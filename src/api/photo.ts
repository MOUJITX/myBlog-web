...
export const updatePhoto = (photo: IPhoto) => request.put('/photo/update', photo)

export const selectPhotoByID = (id: string) => request.get(`/photo/selectById/${id}`)

export const deletePhotoAPI = (id: string) => request.delete(`/photo/del/${id}`)

export const deletePhotosAPI = (ids: string[]) => request.delete('/photo/del/batch', {data: ids})
