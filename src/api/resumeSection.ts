...
export const insetResumeSection = (resumeSection: IResumeSection) => request.post('/resumeSection/add', resumeSection)
...
export const updateResumeSectionRange = (oldIndex: number, newIndex: number) =>
    request.post(`/resumeSection/updateRange?oldIndex=${oldIndex}&newIndex=${newIndex}`, {})

export const selectResumeSectionByID = (id: string) => request.get(`/resumeSection/selectById/${id}`)

export const deleteResumeSectionAPI = (id: string) => request.delete(`/resumeSection/del/${id}`)
