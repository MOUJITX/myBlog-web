...
export const getArticlesPage = (
  ...
  request.post(
    `/article/pageSelect?pageNum=${pageNum}&pageSize=${pageSize}`,
    article,
  );
...
export const getArticlesList = (
  ...
  request.post(
    `/article/page?pageNum=${pageNum}&pageSize=${pageSize}`,
    article,
  );

export const insetArticle = (article: IArticle) =>
  request.post('/article/add', article);

export const updateArticle = (article: IArticle) =>
  request.put('/article/update', article);

export const selectArticleByID = (id: string) =>
  request.get(`/article/selectById/${id}`);

export const deleteArticleAPI = (id: string) =>
  request.delete(`/article/del/${id}`);
