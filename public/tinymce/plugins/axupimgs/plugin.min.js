  ...
  tinymce.PluginManager.add("axupimgs",function(a,k){window.axupimgs={};var f=tinymce.baseURL+"/plugins/axupimgs/upfiles.html";axupimgs.images_upload_handler=a.getParam("axImages_upload_handler",void 0,"function");axupimgs.images_upload_base_path=a.getParam("images_upload_base_path","","string");axupimgs.axupimgs_filetype=a.getParam("axupimgs_filetype",".png,.gif,.jpg,.jpeg","string");axupimgs.res=[];var e=function(){return a.windowManager.openUrl({title:"\u591a\u56fe\u7247\u4e0a\u4f20",size:"large",
  ...
  a.ui.registry.addButton("axupimgs",{icon:"axupimgs",tooltip:"\u591a\u56fe\u7247\u4e0a\u4f20",onAction:function(){e()}});a.ui.registry.addMenuItem("axupimgs",{icon:"axupimgs",text:"\u56fe\u7247\u6279\u91cf\u4e0a\u4f20...",onAction:function(){e()}});return{getMetadata:function(){return{name:"Ax\u591a\u56fe\u7247\u4e0a\u4f20",url:"http://tinymce.ax-z.cn/more-plugins/axupimgs.php"}}}});
